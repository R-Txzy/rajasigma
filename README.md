...
> JANGAN MENJALANKAN BOT DI PANEL ORANG LAIN (BELI DARI ANAK JB) "Kang nyolong Script". Silahkan gunakan server yang di rekomendasikan di bawah yang pastinya dengan harga yang terjangkau dan kualitas baik.

> TIDAK MENERIMA REQUEST FITUR KECUALI ADA FITUR ERROR SILAHKAN BUAT ISSUE DAN AKAN DI USAHAKAN UNTUK DI PERBAIKI, SEMUA UPDATE SCRIPT INI BERDASARKAN KEHENDAK KREATOR, ERROR YANG MUNCUL DILUAR SCRIPT DEFAULT DILUAR TANGGUNG JAWAB KREATOR. _(DO NOT ACCEPT FEATURE REQUEST UNLESS THERE IS AN ERROR FEATURE THAT CAN CREATE AN ISSUE AND TRY TO BE FIXED, ALL UPDATES TO THIS SCRIPT ARE BASED ON THE WILL OF THE CREATOR, ERROR THAT APPEARS OUTSIDE THE DEFAULT SCRIPT IS OUTSIDE THE RESPONSIBILITY OF THE CREATOR.)_
