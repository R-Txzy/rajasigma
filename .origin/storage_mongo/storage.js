...
exports.run = {
   ...
   async: async (m, {
      ...
      try {
         if (!process.env.DATABASE_URL || (process.env.DATABASE_URL || !/mongo/.test(process.env.DATABASE_URL))) return m.reply(Func.texted('bold', '🚩 You must use mongodb to use this feature.'))
