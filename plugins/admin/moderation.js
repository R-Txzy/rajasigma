exports.run = {
   usage: ['autoreply', 'antidelete', 'adminonly', 'autosticker', 'viewonce', 'antibot', 'antilink', 'antivirtex', 'restrict', 'left', 'filter', 'localonly', 'welcome', 'game', 'mysterybox'],
   use: 'on / off',
   ...
   async: async (m, {
      ...
      try {
         ...
         if (!isBotAdmin && /antibot|antilink|antivirtex|filter|localonly|restrict/.test(type)) return client.reply(m.chat, global.status.botAdmin, m)
