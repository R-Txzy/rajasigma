...
exports.run = {
   ...
   async: async (m, {
      ...
      try {
         if (typeof global.db.users.find(v => v.jid == m.sender).verified == undefined) {
            global.db.users.find(v => v.jid == m.sender).verified = false
            return
         }
         ...
         if (!args || !args[0]) return client.reply(m.chat, Func.example(isPrefix, command, 'neoxrbot@gmail.com'), m)
