...
global.header = `© satoru-bot v${require('package.json').version}`
global.footer = `ʟɪɢʜᴛᴡᴇɪɢʜᴛ ᴡᴀʙᴏᴛ ᴍᴀᴅᴇ ʙʏ ʀᴀᴊᴀ ッ`
global.status = Object.freeze({
   process: Func.Styles('Please wait . . .'),
   ...
   moderator: Func.Styles('This command only for owner & moderator.'),
